...
public class StrategyRunner {
         ...
         *
         * The naming convention for state is: pos_[RAW_INDEX]_[COLUMN_INDEX]
         *
         */
    public static UtilityCalculator buildMDPAndExactSolutionMethodsExample(){
        ...
        State s41 = new State("pos_4_1", false, false, 0.0);
        states.put(s41.getId(), s41);
        ...
        State s42 = new State("pos_4_2", false, false, -1.0);
        states.put(s42.getId(), s42);
        ...
        State s43 = new State("pos_4_3", false, true, 1.0);
        states.put(s43.getId(), s43);
        ...
        // 10 percents probability that, when trying to go left, it goes up instead (-Noise).
        Transition t8 = new Transition(s11, s12, left, 0.1);
        transitions.put(t8.getTransitionId(), t8);

        // s12 transitions:
        Transition t10 = new Transition(s21, s31, right, 0.8);
        transitions.put(t10.getTransitionId(), t10);
        Transition t12 = new Transition(s21, s21, right, 0.2);
        transitions.put(t12.getTransitionId(), t12);
        Transition t13 = new Transition(s21, s22, up, 0.8);
        transitions.put(t13.getTransitionId(), t13);
        Transition t14 = new Transition(s21, s31, up, 0.1);
        transitions.put(t14.getTransitionId(), t14);
        Transition t15 = new Transition(s21, s11, up, 0.1);
        transitions.put(t15.getTransitionId(), t15);
        Transition t16 = new Transition(s21, s11, left, 0.8);
        transitions.put(t16.getTransitionId(), t16);
        Transition t18 = new Transition(s21, s21, left, 0.2);
        transitions.put(t18.getTransitionId(), t18);

        // s13 transitions:
        Transition t19 = new Transition(s31, s41, right, 0.8);
        transitions.put(t19.getTransitionId(), t19);
        Transition t20 = new Transition(s31, s32, right, 0.1);
        transitions.put(t20.getTransitionId(), t20);
        Transition t21 = new Transition(s31, s31, right, 0.1);
        transitions.put(t21.getTransitionId(), t21);
        Transition t22 = new Transition(s31, s32, up, 0.8);
        transitions.put(t22.getTransitionId(), t22);
        Transition t23 = new Transition(s31, s41, up, 0.1);
        transitions.put(t23.getTransitionId(), t23);
        Transition t24 = new Transition(s31, s21, up, 0.1);
        transitions.put(t24.getTransitionId(), t24);
        Transition t25 = new Transition(s31, s21, left, 0.8);
        transitions.put(t25.getTransitionId(), t25);
        Transition t26 = new Transition(s31, s32, left, 0.1);
        transitions.put(t26.getTransitionId(), t26);
        Transition t27 = new Transition(s31, s31, left, 0.1);
        transitions.put(t27.getTransitionId(), t27);


        // s14 transitions:
        Transition t28 = new Transition(s41, s41, right, 0.8);
        transitions.put(t28.getTransitionId(), t28);
        Transition t29 = new Transition(s41, s42, right, 0.1);
        transitions.put(t29.getTransitionId(), t29);
        Transition t30 = new Transition(s41, s31, right, 0.1);
        transitions.put(t30.getTransitionId(), t30);
        Transition t31 = new Transition(s41, s42, up, 0.8);
        transitions.put(t31.getTransitionId(), t31);
        Transition t32 = new Transition(s41, s41, up, 0.1);
        transitions.put(t32.getTransitionId(), t32);
        Transition t33 = new Transition(s41, s31, up, 0.1);
        transitions.put(t33.getTransitionId(), t33);
        Transition t34 = new Transition(s41, s31, left, 0.8);
        transitions.put(t34.getTransitionId(), t34);
        Transition t35 = new Transition(s41, s42, left, 0.1);
        transitions.put(t35.getTransitionId(), t35);
        Transition t36 = new Transition(s41, s41, left, 0.1);
        transitions.put(t36.getTransitionId(), t36);


        // s21 transitions:
        Transition t37 = new Transition(s12, s12, right, 0.9);
        transitions.put(t37.getTransitionId(), t37);
        Transition t38 = new Transition(s12, s13, right, 0.1);
        transitions.put(t38.getTransitionId(), t38);
        Transition t40 = new Transition(s12, s13, up, 0.8);
        transitions.put(t40.getTransitionId(), t40);
        Transition t41 = new Transition(s12, s12, up, 0.2);
        transitions.put(t41.getTransitionId(), t41);
        Transition t43 = new Transition(s12, s12, left, 0.9);
        transitions.put(t43.getTransitionId(), t43);
        Transition t44 = new Transition(s12, s13, left, 0.1);
        transitions.put(t44.getTransitionId(), t44);

        // s23 transitions:
        Transition t49 = new Transition(s32, s42, right, 0.8);
        transitions.put(t49.getTransitionId(), t49);
        Transition t50 = new Transition(s32, s32, right, 0.1);
        transitions.put(t50.getTransitionId(), t50);
        Transition t56 = new Transition(s32, s33, right, 0.1);
        transitions.put(t56.getTransitionId(), t56);
        Transition t51 = new Transition(s32, s33, up, 0.8);
        transitions.put(t51.getTransitionId(), t51);
        Transition t52 = new Transition(s32, s42, up, 0.1);
        transitions.put(t52.getTransitionId(), t52);
        Transition t53 = new Transition(s32, s32, up, 0.1);
        transitions.put(t53.getTransitionId(), t53);
        //// ???
        Transition t54 = new Transition(s32, s32, left, 0.9);
        transitions.put(t54.getTransitionId(), t54);
        Transition t55 = new Transition(s32, s31, left, 0.1);
        transitions.put(t55.getTransitionId(), t55);
        Transition t57 = new Transition(s32, s33, left, 0.1);
        ...
        // s31 transitions:
        Transition t73 = new Transition(s13, s23, right, 0.8);
        transitions.put(t73.getTransitionId(), t73);
        Transition t74 = new Transition(s13, s13, right, 0.2);
        transitions.put(t74.getTransitionId(), t74);
        Transition t75 = new Transition(s13, s13, up, 0.9);
        transitions.put(t75.getTransitionId(), t75);
        Transition t76 = new Transition(s13, s23, up, 0.1);
        transitions.put(t76.getTransitionId(), t76);
        Transition t77 = new Transition(s13, s13, left, 0.9);
        transitions.put(t77.getTransitionId(), t77);
        Transition t78 = new Transition(s13, s12, left, 0.1);
        transitions.put(t78.getTransitionId(), t78);

        // s32 transitions:
        Transition t106 = new Transition(s23, s33, right, 0.8);
        transitions.put(t106.getTransitionId(), t106);
        Transition t107 = new Transition(s23, s23, right, 0.2);
        transitions.put(t107.getTransitionId(), t107);

        Transition t108 = new Transition(s23, s23, up, 0.8);
        transitions.put(t108.getTransitionId(), t108);
        Transition t109 = new Transition(s23, s33, up, 0.1);
        transitions.put(t109.getTransitionId(), t109);
        Transition t110 = new Transition(s23, s13, up, 0.1);
        transitions.put(t110.getTransitionId(), t110);
        Transition t111 = new Transition(s23, s13, left, 0.8);
        transitions.put(t111.getTransitionId(), t111);
        Transition t112 = new Transition(s23, s23, left, 0.2);
        transitions.put(t112.getTransitionId(), t112);

        // s33 transitions:
        Transition t83 = new Transition(s33, s43, right, 0.8);
        ...
        Transition t85 = new Transition(s33, s32, right, 0.1);
        ...
        Transition t87 = new Transition(s33, s43, up, 0.1);
        transitions.put(t87.getTransitionId(), t87);
        Transition t88 = new Transition(s33, s23, up, 0.1);
        transitions.put(t88.getTransitionId(), t88);
        Transition t89 = new Transition(s33, s23, left, 0.8);
        transitions.put(t89.getTransitionId(), t89);
        Transition t90 = new Transition(s33, s32, left, 0.1);
        ...
        // s34 transitions: Not allowed ( Don't exist) due to the problem constraints.
    ...
    public static UtilityCalculator buildBookExample(){
        ...
        Transition t12 = new Transition(s21, s21, right, 0.2);
        transitions.put(t12.getTransitionId(), t12);
        Transition t13 = new Transition(s21, s21, up, 0.8);
        transitions.put(t13.getTransitionId(), t13);
        Transition t14 = new Transition(s21, s31, up, 0.1);
        transitions.put(t14.getTransitionId(), t14);
        Transition t15 = new Transition(s21, s11, up, 0.1);
        ...
        Transition t46 = new Transition(s12, s11, down, 0.8);
        transitions.put(t46.getTransitionId(), t46);
        Transition t47 = new Transition(s12, s12, down, 0.2);
        ...
        Transition t57 = new Transition(s32, s33, left, 0.1);
        transitions.put(t57.getTransitionId(), t57);
        Transition t58 = new Transition(s32, s31, down, 0.8);
        transitions.put(t58.getTransitionId(), t58);
        Transition t59 = new Transition(s32, s32, down, 0.1);
        transitions.put(t59.getTransitionId(), t59);
        Transition t60 = new Transition(s32, s42, down, 0.1);
...
//        // s24 transitions: Not allowed ( Don't exist) due to the problem constraints.
        ...
        Transition t80 = new Transition(s13, s12, down, 0.8);
        transitions.put(t80.getTransitionId(), t80);
        Transition t81 = new Transition(s13, s13, down, 0.1);
        transitions.put(t81.getTransitionId(), t81);
        Transition t82 = new Transition(s13, s23, down, 0.1);
        ...
        Transition t113 = new Transition(s23, s23, down, 0.8);
        transitions.put(t113.getTransitionId(), t113);
        Transition t114 = new Transition(s23, s33, down, 0.1);
        transitions.put(t114.getTransitionId(), t114);
        Transition t115 = new Transition(s23, s13, down, 0.1);
        ...
        Transition t91 = new Transition(s33, s33, left, 0.1);
        transitions.put(t91.getTransitionId(), t91);
        Transition t92 = new Transition(s33, s32, down, 0.8);
        transitions.put(t92.getTransitionId(), t92);
        Transition t93 = new Transition(s33, s13, down, 0.1);
        transitions.put(t93.getTransitionId(), t93);
        Transition t94 = new Transition(s33, s43, down, 0.1);
